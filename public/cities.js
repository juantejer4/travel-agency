...
function generateCityRow(city) {
    return `
          <tr>
              ...
              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${city.arrivingFlights}</td>
              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${city.departingFlights}</td>
